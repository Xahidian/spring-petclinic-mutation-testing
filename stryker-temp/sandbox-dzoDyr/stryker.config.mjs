...
export default {
  ...
  testRunner: "command",
  commandRunner: {
    command: "npx playwright test tests/playwright-test.spec.ts --workers=4 --timeout=20000"
 // Run Playwright tests with 2 workers & shorter timeout
  },
  reporters: ["html", "clear-text", "progress"], // Enables real-time progress in terminal
  timeoutMS: 10000, // Reduce Stryker timeout to 30s to avoid long waits
  concurrency: 4, // Run 2 Playwright tests in parallel
